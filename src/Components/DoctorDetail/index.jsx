...
const DoctorDetail = () => {
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      const res = await fetch("https://appointment-booking-healthcare-2.onrender.com/appointment", {
        method: "POST",
  ...
  useEffect(() => {
    const fetchDoctor = async () => {
      try {
        const res = await fetch(`https://appointment-booking-healthcare-2.onrender.com/doctors/${id}`
)
